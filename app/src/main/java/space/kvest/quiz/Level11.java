...
public class Level11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level11.this, GameLevels.class); //создали намерение для перехода
        ...
        img_right.setImageResource(array.images11[numRight]);//достаём из массива картинку
        text_right.setText(array.texts11[numRight]);//Достаём из массива текст

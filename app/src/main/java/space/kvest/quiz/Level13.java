...
public class Level13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.previewimg13);
        ...
        dialogfon.setBackgroundResource(R.drawable.previewbackground13);
        //Устанавливаем фон диалогового окна - конец

        //Устанавливаем описание задания - начало
        TextView textdescription = (TextView)dialog.findViewById(R.id.textdescription);
        textdescription.setText(R.string.levelthirteen);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level13.this, GameLevels.class); //создали намерение для перехода
        ...
        textdescriptionEnd.setText(R.string.levelthirteenEnd);
        ...
        numLeft = random.nextInt(12); // генерируем случайное число
        img_left.setImageResource(array.images13[numLeft]); //достаём из массива картинку
        text_left.setText(array.texts13[numLeft]); //достаём из массива текст

        numRight = random.nextInt(12); // генерируем случайное число
        ...
        img_right.setImageResource(array.images13[numRight]);//достаём из массива картинку
        text_right.setText(array.texts13[numRight]);//Достаём из массива текст

...
public class Level15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.setImageResource(R.drawable.level10);
        ...
        dialogfon.setBackgroundResource(R.drawable.previewbackground10);
        //Устанавливаем фон диалогового окна - конец
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level15.this, GameLevels.class); //создали намерение для перехода
        ...
        dialogfonEnd.setBackgroundResource(R.drawable.previewbackground10);
        //Устанавливаем фон диалогового окна - конец
        ...
        img_left.setImageResource(array.images15[numLeft]); //достаём из массива картинку
        text_left.setText(array.texts15[numLeft]); //достаём из массива текст

        numRight = random.nextInt(10); // генерируем случайное число от
        ...
        img_right.setImageResource(array.images15[numRight]);//достаём из массива картинку
        text_right.setText(array.texts15[numRight]);//Достаём из массива текст

...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnclose.setBackgroundResource(R.drawable.button_stroke_white_pressed_blue);
        ...
        btncontinue.setBackgroundResource(R.drawable.button_stroke_white_pressed_blue);
        btncontinue.setTextColor(R.color.white);
        ...
        numLeft = random.nextInt(8); // генерируем случайное число от 0 до 8
        ...
        numRight = random.nextInt(8); // генерируем случайное число от 0 до 9
        ...
        text_right.setText(array.texts3[numRight]);//Достаём из массива текст
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if (count==20){
                        ...
                        numRight = random.nextInt(8); // генерируем случайное число от
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if (count==20){
                        ...
                        numLeft = random.nextInt(8); // генерируем случайное число от
                        img_left.setImageResource(array.images3[numLeft]); //достаём из массива картинку
                        img_left.startAnimation(a);
                        text_left.setText(array.texts3[numLeft]); //достаём из массива текст
